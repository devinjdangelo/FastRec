...
![untrained_example_supervised](https://github.com/devinjdangelo/GraphSimEmbed/blob/master/examples/graphics/untrained_example_supervised.png =250x250)
...
```
![supervisedgif](https://github.com/devinjdangelo/GraphSimEmbed/blob/master/examples/graphics/supervised.gif =250x250)
![150epochs_supervised_trained](https://github.com/devinjdangelo/GraphSimEmbed/blob/master/examples/graphics/150epochs_supervised_trained.png =250x250)
